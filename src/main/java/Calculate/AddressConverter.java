...
public class AddressConverter {
 ...
 public static void main(String[] args) throws IOException {
  ...
  {
   for(reSults re : res.getreSults())
   {
       
       
    System.out.println("Lattitude of address is :"  + re.getGeometry().getLocation().getLat() );
    System.out.println("Longitude of address is :" + re.getGeometry().getLocation().getLng());
    System.out.println("Location is " + re.getGeometry().getLocation_type());
   }
  }
  else
  {
  ...
  {
   for(reSults re : res1.getreSults())
   {
    System.out.println("address is :"  +re.getFormatted_address());
   }
  }
  else
  {
